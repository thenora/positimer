  ...
  return (
    <section className="section">
      <div className="container content">
        <h3 className="heading title is-3">
          Information that is gathered from visitors
        </h3>
        <p className="text">
          In common with other websites, log files are stored on the web server
          saving details such as the visitor's IP address, browser type,
        ...
        <h3 className="heading title is-3">Visitor Options</h3>
        <p className="text">
          If you have subscribed to one of our services, you may unsubscribe by
          following the instructions which are included in e-mail that you
          receive.
        </p>
        ...
        <h3 className="heading title is-3">Cookies</h3>
        ...
        <h3 className="heading title is-3">Google Ads</h3>
        ...
        <p>
          Website visitors may opt out of the use of the DART cookie by visiting
