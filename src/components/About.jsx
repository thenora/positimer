      ...
      <section className="section">
        <div className="container content">
          <div className="box cta">
            <h1 className="title">About Positimer</h1>
            <div className="content is-medium">
              <p className="has-text-centered text">
                ...
                because I couldn't find the encouraging work/break timer I
                wanted to help with motivation and focus.
              </p>
              <p className="has-text-centered text">
              ...
              <p className="has-text-centered text">
                Please contact me at positimer @ gmail . com with any questions
                or suggestions.
              </p>
            </div>
          </div>
